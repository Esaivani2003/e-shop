...
const products = [
  ...
  { id: 4, name: "Smart Watch", price: 299, image: "/images/keyboard.jpg", description: "Feature-packed smartwatch with health tracking." },
];
...
export default function ProductDetailPage() {
  ...
  // ✅ Ensure the product object has a quantity before adding to cart
    ...
    <div className="p-6 bg-gray-100 min-h-screen flex justify-center">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg">
        ...
        <button
          ...
          onClick={() => addToCart({...product,quantity:1})} // ✅ Use productWithQuantity
        >
